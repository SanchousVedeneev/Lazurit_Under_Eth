...
MODULE_PATHS:=Drivers/ModbusSS/ Drivers/Ethernet/ 

# MODULES_C:=$(shell find ${MODULE_PATHS} -type f -name "*.c" -exec basename {} \;)
...
######################################
USER_MODULES_SRC = \
ioLibrary_Driver-master/Ethernet/W5500/w5500.c \
ioLibrary_Driver-master/Ethernet/socket.c \
ioLibrary_Driver-master/Ethernet/wizchip_conf.c \
ioLibrary_Driver-master/Internet/DHCP/dhcp.c \
Drivers/Parameters/param.c\
Drivers/BSP/BSP_ICA2D13.c\
${MODULES_C}

# $(info src list: ${USER_MODULES_SRC})

USER_MODULES_INC = \
-IioLibrary_Driver-master/Ethernet \
-IioLibrary_Driver-master/Ethernet/W5500 \
-IioLibrary_Driver-master/Internet/DHCP \
-IDrivers/Parameters \
-IDrivers/Ethernet/Http \
-IDrivers/BSP \
${MODULES_H_DIR}
...
flash:
	openocd -f ./stlink.cfg  -f ./stm32f1x_geehy.cfg  -c "program $(BUILD_DIR)/$(TARGET).elf verify reset exit"
 
#######################################
# erase
#######################################
erase:
	openocd -f ./stlink.cfg  -f ./stm32f1x_geehy.cfg  -c "init; reset halt; stm32g4x mass_erase 0; exit"
